...
export const Route = createFileRoute("/invest")({
  head: () => ({
    meta: [
      { title: "Invest — Node" },
      { name: "description", content: "Invest in Node, a small software studio built by an 11-year-old in Milford, MI. Pick an amount and reach out to start a conversation." },
      { property: "og:title", content: "Invest — Node" },
      { property: "og:description", content: "Back Node with an investment — choose an amount and get in touch." },
      { property: "og:url", content: "https://nodefms.lovable.app/invest" },
    ],
    links: [{ rel: "canonical", href: "https://nodefms.lovable.app/invest" }],
  }),
...
function InvestPage() {
  ...
  const mailto = useMemo(() => {
    const subject = encodeURIComponent("I'd like to invest in Node");
    const body = encodeURIComponent(
      `Hi Henry,\n\nI'd like to invest in Node.\n\nAmount I'm willing to invest: $${num.toLocaleString()}\nExchange amount: ${exchange || "(let's discuss)"}\n\nThanks!`,
    );
    ...
    <div className="min-h-screen bg-surface text-ink">
            ...
            <div className="max-w-3xl mx-auto px-6 text-center">
              <Reveal>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/15 bg-white/[0.04] backdrop-blur text-[11px] font-mono uppercase tracking-[0.18em] text-white/70 mb-6">
                  <TrendingUp className="size-3" /> Invest in Node
                </div>
                <h1 className="text-4xl md:text-6xl font-semibold leading-tight tracking-tight text-balance">
                  Back a builder, not a giant company.
                </h1>
                <p className="mt-6 text-lg text-white/70 text-pretty max-w-[52ch] mx-auto">
                  Node is a small studio run by an 11-year-old in Milford, MI. If you believe in
                  what's being built, here's how to invest.
                </p>
              </Reveal>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-2xl font-semibold tracking-tight">How to invest</h2>
          <ol className="mt-6 space-y-4">
            ...
            <li className="flex gap-4 p-5 bg-card rounded-2xl ring-1 ring-black/5">
              ...
              <div>
                <div className="font-semibold">Add the amount you're willing to invest and the exchange amount</div>
                <p className="mt-1 text-sm text-muted-foreground">
                  Tell me how much you'd like to invest, and what you'd like in exchange. Use the
          ...
          <div className="mt-8 p-6 md:p-8 bg-card rounded-3xl ring-1 ring-black/5 shadow-elegant">
            <h3 className="text-lg font-semibold tracking-tight">Draft your investment</h3>
            <div className="mt-5 grid sm:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                <label htmlFor="amount" className="text-xs font-medium">Amount you're willing to invest ($)</label>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="e.g. 5% equity, credit, or a thank-you"
            ...
            >
              <Mail className="size-4" /> Email my investment offer <ArrowRight className="size-4" />
            </a>
          </div>
        </div>
      </section>
